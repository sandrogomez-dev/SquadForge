    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-b border-white/10">
            <div className="flex flex-col space-y-4">
              ...
              <button className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-2 rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all text-left">
                Iniciar Sesión
              </button>
            </div>
          </div>
      ...
      <main className="px-6 py-12 md:py-20">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-300 mb-8 md:mb-12 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-md sm:max-w-none mx-auto">
            <Link 
              href="/groups"
              className="w-full sm:w-auto bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg text-lg font-semibold hover:from-purple-600 hover:to-pink-600 transition-all transform hover:scale-105 text-center"
            >
              Buscar Grupos Ahora
            </Link>
            <button className="w-full sm:w-auto border border-purple-400 text-purple-400 px-6 sm:px-8 py-3 sm:py-4 rounded-lg text-lg font-semibold hover:bg-purple-400 hover:text-white transition-all">
              Ver Demo
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              <div key={game.name} className="bg-white/10 backdrop-blur-sm rounded-lg p-4 md:p-6 text-center hover:bg-white/20 transition-all cursor-pointer">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg mx-auto mb-3 md:mb-4"></div>
                <h3 className="text-white font-semibold mb-1 text-sm md:text-base">{game.name}</h3>
                <p className="text-gray-400 text-xs md:text-sm">{game.players} jugadores activos</p>
              </div>
            ))}
          </div>
        </div>
